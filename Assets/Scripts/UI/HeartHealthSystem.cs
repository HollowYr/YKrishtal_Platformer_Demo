/***
 * Logic part of Heart Health system.
 * Damages, Heals player then connect with events to HeartHealthVisual.
 ***/
using System;
...
public class HeartHealthSystem
{
    ...
    public HeartHealthSystem(int heartAmount, HeartsHealthVisual heartsHealthVisual)
    {
    ...
    {
        heartsHealthVisual.playerScript.audioManager.Play("Player_Hurt");
